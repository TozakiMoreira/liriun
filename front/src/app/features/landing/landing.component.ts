        ...
        <div class="flex flex-col items-center gap-8 text-center w-full">
          <div class="flex flex-col items-center gap-3">
            ...
            <p class="text-text-dim text-base md:text-lg leading-relaxed max-w-2xl">
              ...
              tarefa completa — com checklist do que ainda precisa resolver.
            </p>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        class="text-[8px] px-1 py-px rounded-full bg-danger/15 text-danger font-semibold"
                        >3</span
                      >
                    </div>
                    <div
                    ...
                    <div
                      class="text-[9px] text-text-subtle uppercase tracking-wider px-1 py-1 font-semibold mt-2"
                    >
                      Ajustes
                    </div>
                    <div
                  ...
                  <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div class="flex-1 px-3 py-3 flex flex-col gap-2 overflow-hidden">
                      <div class="flex justify-end">
                        ...
                        >
                          Vou viajar pra Recife em janeiro
                        </div>
                      </div>
                      ...
                      <div class="flex items-start gap-1.5 max-w-[85%]">
                        ...
                        >
                          Que dia você quer começar a se organizar? Imagino que passagem
                          e hospedagem ainda estejam abertas.
                        </div>
                      </div>
