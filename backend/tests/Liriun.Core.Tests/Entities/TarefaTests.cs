...
public class TarefaTests
{
    ...
    public void StatusComputado_retorna_Atrasada_quando_passou_do_fim_do_dia()
    {
        ...
        // BRT 2026-04-21 00:00:01 = UTC 2026-04-21 03:00:01
        DateTime agora = new(2026, 4, 21, 3, 0, 1, DateTimeKind.Utc);
    ...
    public void StatusComputado_respeita_horarioFinal_quando_informado()
    {
        ...
        // BRT 14:00:01 / 13:59:59 = UTC 17:00:01 / 16:59:59
        DateTime depois = new(2026, 4, 20, 17, 0, 1, DateTimeKind.Utc);
        t.StatusComputado(depois).Should().Be(StatusTarefa.Atrasada);

        DateTime antes = new(2026, 4, 20, 16, 59, 59, DateTimeKind.Utc);
